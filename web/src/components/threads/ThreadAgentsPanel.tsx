      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          ...
          {selectedInviteIDs.size > 0 && (
            <Button size="sm" className="h-7 text-xs" onClick={onInviteAgent} disabled={invitingAgent}>
              {invitingAgent ? <Loader2 className="mr-1 h-3.5 w-3.5 animate-spin" /> : <Plus className="mr-1 h-3.5 w-3.5" />}
